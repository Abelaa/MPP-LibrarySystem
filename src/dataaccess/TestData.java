...
public class TestData {
	...
	public static void main(String[] args) {
		 ...
		 * 
			Address addr = new Address("101 S. Main", "Fairfield", "IA", "52556");
			LibraryMember libraryMember = new LibraryMember("9999", "Abel", "Tefera", "641-223-2211", addr);
			SystemController ci = new SystemController();
			Book book = new Book("22-2222", "Abel The Big Fish", 100);
			BookCopy bookCopy = book.getCopies()[0];
			bookCopy.changeAvailability();
			ci.createCheckoutRecordEntry(libraryMember, bookCopy, LocalDate.now(), LocalDate.now());
		*/
